...
// const IMAGES = [
//   "/projects/modern_classic/01.jpg",
//   "/projects/modern_classic/02.jpg",
//   "/projects/modern_classic/03.jpg",
//   "/projects/modern_classic/04.jpg",
//   "/projects/modern_classic/05.jpg",
//   "/projects/modern_classic/06.jpg",
//   "/projects/modern_classic/08.jpg",
//   "/projects/modern_classic/07.jpg",
// ];

// export default function modernclassicPage() {
//   return (
...
// // Top gallery images for Modern Classic
// const IMAGES = [
//   "/projects/modern_classic/01.jpg",
//   "/projects/modern_classic/02.jpg",
//   "/projects/modern_classic/03.jpg",
    ...
    <main className="min-h-screen w-full bg-[#f4f4f5]">
      ...
      <section className="mx-auto max-w-6xl xl:max-w-7xl px-6 lg:px-10 pt-28 sm:pt-32 pb-16">
        <header className="mb-10 flex items-center justify-between">
          <h1 className="font-serif text-3xl tracking-[0.18em] uppercase text-[#2f2a25]">
            Modern Classic
          </h1>

          <Link href="/projects">
            <button className="px-6 py-2 border border-[#d9d9d4] text-[11px] font-semibold tracking-[0.18em] uppercase text-[#5b554b] hover:bg-[#dbdbdc] transition">
              All Projects
            </button>
          </Link>
        </header>
      ...
      {/* ===== SLIDER SECTION ===== */}
      <section ref={sectionRef} className="py-24 bg-[#f4f4f5] overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          <h2 className="mb-12 text-center font-serif text-4xl tracking-[0.25em] uppercase text-[#2f2a25]">
        ...
        <div className="relative">
          <button
            onClick={() => scrollByCard("left")}
            className="hidden lg:flex absolute left-10 top-1/2 -translate-y-1/2 z-20 h-14 w-14 items-center justify-center rounded-full bg-[#dbdbdc]/80 text-white text-2xl"
          >
            ‹
          </button>
          ...
          <button
            onClick={() => scrollByCard("right")}
            className="hidden lg:flex absolute right-10 top-1/2 -translate-y-1/2 z-20 h-14 w-14 items-center justify-center rounded-full bg-[#dbdbdc]/80 text-white text-2xl"
          >
            ›
          </button>
          ...
          <div ref={trackRef} className="flex gap-6 px-16">
            {PROJECTS.map((project) => (
              <Link
                key={project.id}
                href={project.href}
                className="group flex-shrink-0 w-[32vw] max-w-[520px] flex flex-col items-center hover:-translate-y-2 transition"
              >
