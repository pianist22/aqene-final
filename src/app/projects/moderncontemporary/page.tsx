...
// const IMAGES = [
//   "/projects/moderncontemporary/01.jpg",
//   "/projects/moderncontemporary/02.jpg",
//   "/projects/moderncontemporary/03.jpg",
//   "/projects/moderncontemporary/04.jpg",
//   "/projects/moderncontemporary/05.jpg",
//   "/projects/moderncontemporary/06.jpg",
//   "/projects/moderncontemporary/08.jpg",
//   "/projects/moderncontemporary/07.jpg",
// ];

// export default function moderncontemporaryPage() {
//   return (
...
// Top gallery images for Modern Contemporary
const IMAGES = [
  "/projects/moderncontemporary/01.jpg",
  "/projects/moderncontemporary/02.jpg",
  "/projects/moderncontemporary/03.jpg",
  ...
  return (
    <main className="min-h-screen w-full bg-[#f4f4f5]">
      ...
      <section className="mx-auto max-w-6xl xl:max-w-7xl px-6 lg:px-10 pt-28 sm:pt-32 pb-16">
        ...
        {/* Image grid – 1 / 2 / 3 columns, wide cards */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-10 gap-y-12">
          {IMAGES.map((src, idx) => (
            <article key={src} className="flex flex-col">
              <div className="overflow-hidden rounded-3xl bg-[#d4d4d8]">
